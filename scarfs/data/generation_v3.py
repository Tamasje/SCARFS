"""v3 database generation core — v2 architecture with a high-temperature cap for isothermal enrichment.
...
# SCRIPT_COMPATIBILITY_NOTE = "generation_v3 keeps GenV2Settings/run_case_v2 names but uses a 1600 K cap"
...
#: High-temperature campaign cap for v3/isothermal enrichment.
#: Kept under the historic T_MAX_K_V2 name for compatibility with the v2 code path.
T_MAX_K_V3 = 1600.0
T_MAX_K_V2 = T_MAX_K_V3
...
class GenV2Settings:
    ...
    generator_version: str = "v3.0_1600K_cap"
